...
class yolov8_heatmap:
    ...
    def __call__(self, img_path, save_path):
        ...
        if os.path.isdir(img_path):
            ...
            #self.process(img_path, f'{save_path}/GOOD-Net-n-Head4.png')
            self.process(img_path, f'{save_path}/YOLO11n-Head11.png')
            
def get_params():
    params = {
        'weight': 'runs/train/VisDrone/YOLO11n/weights/best.pt',
        #'weight': 'runs/train/VisDrone/GOOD-Net-n/weights/best.pt',
        'device': 'cuda:0',
        'method': 'GradCAM', 
        'layer': [16, 19, 22],
...
if __name__ == '__main__':
    ...
    model('datasets/VisDrone/VisDrone2019-DET-test-challenge/images/9999939_00000_d_0000179.jpg', 'runs/heatmap/GradCAM')